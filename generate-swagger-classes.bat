...
java -jar %SWAGGER_HOME%\modules\swagger-codegen-cli\target\swagger-codegen-cli.jar generate --api-package com.dork.app.react.api -i http://localhost:38806/swagger/v1/swagger.json -l java -o .\swagger